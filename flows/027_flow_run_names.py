...
@flow(name="027_template_named", flow_run_name="report-{env}-{date_str}", log_prints=True)
...
@flow(name="027_callable_named", flow_run_name=generate_flow_name, log_prints=True)
...
@flow(name="027_flow_run_names", log_prints=True)
