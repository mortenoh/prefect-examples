...
_spec = importlib.util.spec_from_file_location(
    "dhis2_worldbank_population_import",
    Path(__file__).resolve().parent.parent.parent / "flows" / "dhis2" / "dhis2_worldbank_population_import.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["dhis2_worldbank_population_import"] = _mod
...
def test_ensure_dhis2_metadata() -> None:
    ...
    assert payload["dataElements"][0]["name"] == "PR: WB: Population"
...
@patch("dhis2_worldbank_population_import.httpx.Client")
