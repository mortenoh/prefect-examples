...
_spec = importlib.util.spec_from_file_location(
    "analytics_multi_indicator_correlation",
    Path(__file__).resolve().parent.parent.parent / "flows" / "analytics" / "analytics_multi_indicator_correlation.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["analytics_multi_indicator_correlation"] = _mod
