...
_spec = importlib.util.spec_from_file_location(
    "analytics_multi_pipeline_orchestrator",
    Path(__file__).resolve().parent.parent.parent / "flows" / "analytics" / "analytics_multi_pipeline_orchestrator.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["analytics_multi_pipeline_orchestrator"] = _mod
