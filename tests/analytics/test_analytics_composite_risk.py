...
_spec = importlib.util.spec_from_file_location(
    "analytics_composite_risk",
    Path(__file__).resolve().parent.parent.parent / "flows" / "analytics" / "analytics_composite_risk.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["analytics_composite_risk"] = _mod
