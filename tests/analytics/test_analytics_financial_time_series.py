...
_spec = importlib.util.spec_from_file_location(
    "analytics_financial_time_series",
    Path(__file__).resolve().parent.parent.parent / "flows" / "analytics" / "analytics_financial_time_series.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["analytics_financial_time_series"] = _mod
