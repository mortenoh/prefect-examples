...
_spec = importlib.util.spec_from_file_location(
    "cloud_s3_parquet_export",
    Path(__file__).resolve().parent.parent.parent / "flows" / "cloud" / "cloud_s3_parquet_export.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["cloud_s3_parquet_export"] = _mod
...
@patch("cloud_s3_parquet_export.S3Bucket")
@patch("cloud_s3_parquet_export.MinIOCredentials")
