...
_spec = importlib.util.spec_from_file_location(
    "patterns_testable_flow_patterns",
    Path(__file__).resolve().parent.parent.parent / "flows" / "patterns" / "patterns_testable_flow_patterns.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["patterns_testable_flow_patterns"] = _mod
