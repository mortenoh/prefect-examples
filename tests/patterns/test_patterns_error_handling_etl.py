...
_spec = importlib.util.spec_from_file_location(
    "patterns_error_handling_etl",
    Path(__file__).resolve().parent.parent.parent / "flows" / "patterns" / "patterns_error_handling_etl.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["patterns_error_handling_etl"] = _mod
