...
_spec = importlib.util.spec_from_file_location(
    "patterns_advanced_state_handling",
    Path(__file__).resolve().parent.parent.parent / "flows" / "patterns" / "patterns_advanced_state_handling.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["patterns_advanced_state_handling"] = _mod
