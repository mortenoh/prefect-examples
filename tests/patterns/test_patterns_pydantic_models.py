...
_spec = importlib.util.spec_from_file_location(
    "patterns_pydantic_models",
    Path(__file__).resolve().parent.parent.parent / "flows" / "patterns" / "patterns_pydantic_models.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["patterns_pydantic_models"] = _mod
