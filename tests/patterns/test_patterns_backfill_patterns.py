...
_spec = importlib.util.spec_from_file_location(
    "patterns_backfill_patterns",
    Path(__file__).resolve().parent.parent.parent / "flows" / "patterns" / "patterns_backfill_patterns.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["patterns_backfill_patterns"] = _mod
