...
_spec = importlib.util.spec_from_file_location(
    "patterns_failure_escalation",
    Path(__file__).resolve().parent.parent.parent / "flows" / "patterns" / "patterns_failure_escalation.py",
)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["patterns_failure_escalation"] = _mod
